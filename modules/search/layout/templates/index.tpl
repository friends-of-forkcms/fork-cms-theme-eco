...
<section id="searchIndex">
	<div class="bd">
		{form:search}
			<p class="bigInput{option:txtQError} errorArea{/option:txtQError}">
				<label for="q" class="accessibility">{$lblSearchTerm|ucfirst}<abbr title="{$lblRequiredField}">*</abbr></label>
				{$txtQ} {$txtQError}
			</p>
			<p>
